...
if __name__ == "__main__":
    ...
    trainEncoded, valEncoded, testEncoded = autoencoder.encodeImages(autoencoderModel, imageSize, trainData), autoencoder.encodeImages(autoencoderModel, imageSize, valData), autoencoder.encodeImages(autoencoderModel, imageSize, testData)
